...
class SpeechRecognizer: NSObject, ObservableObject {
    ...
    private func checkIfSpam(_ text: String) -> Bool {
        let spamKeywords = [
            "free", "offer", "win", "prize", "congratulations",
            "limited time", "urgent", "act now", "lottery", "guaranteed",
            "warranty", "deal", "insurance", "gift", "money", "cheap"
        ]

        let lowercasedText = text.lowercased()
        return spamKeywords.contains { lowercasedText.contains($0) }
    }
}
